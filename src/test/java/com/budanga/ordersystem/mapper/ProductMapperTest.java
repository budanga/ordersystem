...
class ProductMapperTest {
    ...
    void toDTO_mapsAllFields() {
        ...
        Product product = buildProduct(1L, "Laptop", new BigDecimal("999.99"), 10, true, now);
    ...
    void toDTO_mapsInactiveProduct() {
        Product product = buildProduct(2L, "Discontinued", BigDecimal.TEN, 0, false, null);
    ...
    void fromCreateDTO_mapsAllFields() {
        CreateProductDTO createDTO = new CreateProductDTO("Monitor", new BigDecimal("299.50"), 25);
    ...
    void fromCreateDTO_doesNotSetIdOrCreatedAt() {
        CreateProductDTO createDTO = new CreateProductDTO("Keyboard", new BigDecimal("49.99"), 100);
    ...
    void fromCreateDTO_activeDefaultIsTrue() {
        CreateProductDTO createDTO = new CreateProductDTO("Mouse", new BigDecimal("19.99"), 200);
    ...
    void updateFromDTO_updatesAllNonNullFields() {
        Product product = buildProduct(3L, "OldName", new BigDecimal("10.00"), 5, true, null);
        UpdateProductDTO updateDTO = new UpdateProductDTO("NewName", new BigDecimal("20.00"), 10, false);
    ...
    void updateFromDTO_skipNullName() {
        Product product = buildProduct(4L, "OriginalName", new BigDecimal("5.00"), 3, true, null);
        UpdateProductDTO updateDTO = new UpdateProductDTO(null, new BigDecimal("7.00"), null, null);
    ...
    void updateFromDTO_skipNullPrice() {
        Product product = buildProduct(5L, "Widget", new BigDecimal("50.00"), 8, true, null);
        UpdateProductDTO updateDTO = new UpdateProductDTO("Widget Pro", null, 12, null);
    ...
    void updateFromDTO_skipNullStock() {
        Product product = buildProduct(6L, "Gadget", new BigDecimal("15.00"), 20, true, null);
        UpdateProductDTO updateDTO = new UpdateProductDTO(null, null, null, false);
    ...
    void updateFromDTO_skipNullActive() {
        Product product = buildProduct(7L, "Tool", new BigDecimal("8.00"), 15, false, null);
        UpdateProductDTO updateDTO = new UpdateProductDTO(null, null, null, null);
    ...
    void updateFromDTO_flipsActiveToTrue() {
        Product product = buildProduct(8L, "Retired", new BigDecimal("1.00"), 0, false, null);
        UpdateProductDTO updateDTO = new UpdateProductDTO(null, null, null, true);
